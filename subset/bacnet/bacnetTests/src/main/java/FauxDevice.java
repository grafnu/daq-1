...
public class FauxDevice implements Runnable{
    ...
    public static void main(String[] args) throws Exception {
        ...
        new FauxDevice(broadcastIpAddr, IpNetwork.DEFAULT_PORT, localIpAddr);
    }

    public FauxDevice(String broadcastAddress, int port, String localAddress) throws Exception {
